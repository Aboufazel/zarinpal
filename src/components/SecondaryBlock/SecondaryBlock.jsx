            ...
            <Container fluid dir={'rtl'}>
                ...
                <Row>
                    ...
                    <Col xl={7} lg={12} md={12}>
                        <Row className={'d-xl-flex d-none'}>
                ...
                <Row className={'m-1'}>
                    <Col lg={12} md={12} sm={12}
                         className={'zarin_start_block d-flex flex-column align-items-center justify-content-center'}>
                    <span>
                ...
                <Row>
                    <Col md={12} lg={12}
                         className={'d-none align-items-center d-md-flex justify-content-between d-lg-flex support_block'}>
